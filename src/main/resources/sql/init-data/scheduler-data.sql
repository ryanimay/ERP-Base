...
FROM (VALUES
             ...
             ('com.erp.base.config.quartz.job.SalaryCalculationJob', '0 0 10 L * ?', 'DEFAULT', 'Calculate salary per month', 'SalaryCalculationJob', null, 1)) AS source(class_path, cron, group_name, info, name, param, status)
