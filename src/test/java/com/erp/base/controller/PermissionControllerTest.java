...
class PermissionControllerTest {
    ...
    private final List<Integer> permissionArray = List.of(35,18,5,9,31,59,49,37,40,44,52,63,3,56,39,34,29,11,30,42,28,58,1,68,36,12,4,7,21,19,27,6,64,10,13,41,17,62,57,48,32,51,2,67,47,50,43,14,46,20,66,24,60,55,15,23,45,54,22,53,38,65,16,25,26,61,33,8,69,70, 71);
    ...
    void permissionList_ok() throws Exception {
        ...
        resultActions
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].children[0].id").value(model.getId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].children[0].authority").value(model.getAuthority()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].children[0].info").value(model.getInfo()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].children[0].url").value(model.getUrl()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].children[0].status").value(model.getStatus()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[2].children", Matchers.hasSize(1)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[3].children", Matchers.hasSize(7)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[4].children", Matchers.hasSize(4)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[5].children", Matchers.hasSize(4)))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].children", Matchers.hasSize(5)))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[10].children", Matchers.hasSize(6)))
    ...
    void rolePermission_ok() throws Exception {
        ...
        resultActions
                .andExpect(MockMvcResultMatchers.jsonPath("$.data").isArray())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data", Matchers.hasSize(71)))
