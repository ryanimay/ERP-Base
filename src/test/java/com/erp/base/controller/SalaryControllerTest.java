...
class SalaryControllerTest {
    ...
    void salaryRootList_ok() throws Exception {
        ...
        resultActions
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data.data[0].time").value(salaryResponse1.getTime()))
    ...
    void salaryInfo_ok() throws Exception {
        ...
        resultActions
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data.time").value(salaryResponse.getTime()))
