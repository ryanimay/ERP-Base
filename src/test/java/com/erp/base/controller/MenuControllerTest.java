...
class MenuControllerTest {
    ...
    void findAll_ok() throws Exception {
        ...
        resultActions
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[0].name").value("router.clientManagement"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[1].name").value("router.permissionManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[1].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[2].name").value("router.salaryManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[2].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[3].name").value("router.performanceManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[3].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[4].name").value("router.leaveManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[4].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[5].name").value("router.projectManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[5].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].name").value("router.procureManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[6].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[7].name").value("router.jobManagement"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[7].child").isNotEmpty())
                .andExpect(MockMvcResultMatchers.jsonPath("$.data[8].name").value("router.scheduleManagement"))
