...
class ClientControllerTest {
    ...
    void setMessageSource(){
        ...
        ms.setDefaultLocale(ClientIdentity.defaultLocale);
    ...
    @Test
    void register_whenUserNameAlreadyExists_badRequest() throws Exception {
        ...
        ResultActions perform = mockMvc.perform(MockMvcRequestBuilders.post("/client/register")
                .contentType(MediaType.APPLICATION_JSON)
                .content(jsonRequest));
        ResponseExpectation.expectStatusIs(perform, ApiResponseCode.USERNAME_ALREADY_EXIST);
